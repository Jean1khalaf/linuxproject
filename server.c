...
printf("client trouve:% s \ n", clients[i].utilisateur);
            
find = i;
            
strcpy(resultat, surnom);
            
strcat(resultat," quitteter le group \n");
...
printf("Cet utilisateur n'existe pas \ n");
...
int principe(int argc,char *argv[]) 
{
    
printf("Démarrage du serveur ...)\n");
    
printf("Attendez que le client se connecte ... si vous voulez fermer le serveur, tapez simplement "_shdn") \ n");
...
strcat(resultat," a été ajouté au groupe \ n");
