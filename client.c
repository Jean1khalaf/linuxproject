...
while((longueur = recv(sock,message,500,0)) > 0) 
{
...
printf("nomusr n'est pas envoyé au serveur \ n");
...
printf("Bienvenue aux gars à ChatRoom:) \ n");
    
printf("Type '_connect <surnom> <machine> <port>' et connectez-vous à votre serveur maintenant. \ n");
    
printf("Type '_quit' se déconnecter de votre serveur. \ n");
